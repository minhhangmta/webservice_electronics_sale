...
<html lang="en">
    ...
    <head>
        <title>Electronic Store | Login</title><meta charset="UTF-8" />
    ...
    <body>
        <div id="loginbox">                  
            <form id="loginform" class="form-vertical" modelAttribute="userFormData" action="${pageContext.request.contextPath}/admin/login" method="post">
